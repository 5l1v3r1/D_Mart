		...
		<td style="width: 50%;  vertical-align: top;">
			<table style="width: 90%">
				...
				<Tr>
					...
					<Td>
						<input type="text" name="admin_quantity" value="1" size="5" style="text-align: center;">
					</Td>
				</Tr>
				<tr>
					<td colspan="3" style="text-align: center;">
						<Br>
						<input type="hidden" name="product_num" value="<%=bean.getInumber() %>"> <!-- 값을 넘기지만 보이지 않게 -->
						<input type="submit" value="물품 주문">
